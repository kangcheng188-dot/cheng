...
const I18N = {
  en: {
    ...
    controlsText: 'Controls: move the mouse to the screen edges (or drag / swipe) to scroll the battlefield. Space = pause.',
  ...
  zh: {
    ...
    controlsText: '操作：鼠标移到屏幕左右边缘（或按住拖动 / 手指滑动）来滚动战场；空格键暂停。',
